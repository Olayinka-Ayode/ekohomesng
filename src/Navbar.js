...
const Navbar = () => {
    ...
    return (
        <nav className='flex justify-around items-center relative'>
            ...
            <FontAwesomeIcon icon={icons} className="cursor-pointer" onClick={(e) => {checkIconClick(e)}}/>
            <div className="list-container w-1/3 items-center absolute top-16 left-12 text-left hidden" id="listNav">
                <ul className='md:flex justify-around items-center font-playPen'>
                    <li><a href="#">Home</a></li>
