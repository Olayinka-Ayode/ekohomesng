            ...
            <Swiper spaceBetween={50} slidesPerView={slides} autoplay={{delay: 2500, disableOnInteraction: false,}} pagination={{clickable: true,}} navigation={true} modules={[Autoplay, Pagination, Navigation]} loop={true}>
                <SwiperSlide>
                    <div className='flex flex-col items-center justify-center'>
                        ...
                        <p className='text-justify px-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit beatae pariatur dignissimos quod, ab delectus odio. Libero amet magnam, nisi nulla ea iure. Vitae laudantium praesentium labore culpa aperiam ducimus.</p>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className='flex flex-col items-center justify-center'>
